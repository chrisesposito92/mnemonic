...
- [ ] **Phase 26: Proto Foundation** - Resolve tonic/prost version conflict, define mnemonic.proto, wire build.rs codegen, update CI with protoc installation
- [ ] **Phase 27: Dual-Server Skeleton and Auth Layer** - Start REST+gRPC dual-port via tokio::try_join!, implement async Tower auth layer, add grpc_port config
- [ ] **Phase 28: Core RPC Handlers, Health, and Discoverability** - Implement all four hot-path RPCs, standard health service, optional reflection for grpcurl
- [ ] **Phase 29: StorageBackend Routing Fix** - Route recall CLI through StorageBackend trait, making ListMemories work correctly across all backends
