...
### Integration Tests (tests/integration.rs — 6 embedding tests)
...
| `test_openai_embedding` *(ignored)* | OpenAI API returns 384-dim L2-normalized vector, empty input errors | EMBD-04 |
...
| EMBD-04 | OpenAI fallback provider | `test_openai_engine_send_sync`, `test_both_engines_as_trait_object`, `test_openai_embedding` (ignored) | — | Full (verified 2026-03-19 with live key) |
...
| Fully covered (automated) | 5 (EMBD-01, EMBD-02, EMBD-03, EMBD-04, EMBD-05) |
| Partially covered | 0 |
| Missing | 0 |
| Total automated tests | 11 (5 unit + 6 integration, 1 ignored without key) |
| All tests passing | 21/21 default + 1/1 ignored (with key) |
| Gaps found | 1 (EMBD-04 live API test) |
| Resolved | 1 (added test_openai_embedding, verified with live key) |
| Escalated | 0 |
